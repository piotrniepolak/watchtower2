    ...
    const sampleConflicts: Conflict[] = [
      {
        ...
        description: "Ongoing military conflict with recent developments in drone warfare and territorial dynamics. Over 200,000 military casualties combined (June 2025).",
        severity: "High",
        status: "Active",
        duration: "3+ years",
