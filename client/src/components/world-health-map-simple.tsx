  ...
  const countries: Record<string, any> = {
    ...
    'FRA': {
      ...
      indicators: {
        ...
        'Adolescent birth rate (per 1000 women aged 15-19 years)': 4.6,
        'Age-standardized mortality rate attributed to household and ambient air pollution  (per 100 000 population)': 11.941,
        'Age-standardized prevalence of tobacco use among persons 15 years and older  (%)': 33.4,
        'Annual mean concentrations of fine particulate matter (PM2.5) in urban areas (µg/m3)': 11.93,
    ...
    'GBR': {
      ...
      indicators: {
        ...
        'Adolescent birth rate (per 1000 women aged 15-19 years)': 11.9,
        'Age-standardized mortality rate attributed to household and ambient air pollution  (per 100 000 population)': 12.8,
        'Age-standardized prevalence of tobacco use among persons 15 years and older  (%)': 16.5,
        'Annual mean concentrations of fine particulate matter (PM2.5) in urban areas (µg/m3)': 10.8,
    ...
    'JPN': {
      ...
      indicators: {
        'Adolescent birth rate (per 1000 women aged 10-14 years)': 0.0,
        'Adolescent birth rate (per 1000 women aged 15-19 years)': 3.4,
        'Age-standardized mortality rate attributed to household and ambient air pollution  (per 100 000 population)': 15.2,
        'Age-standardized prevalence of tobacco use among persons 15 years and older  (%)': 20.1,
        'Annual mean concentrations of fine particulate matter (PM2.5) in urban areas (µg/m3)': 11.9,
    ...
    'IND': {
      ...
      indicators: {
        ...
        'Adolescent birth rate (per 1000 women aged 15-19 years)': 15.6,
        'Age-standardized mortality rate attributed to household and ambient air pollution  (per 100 000 population)': 234.4,
        'Age-standardized prevalence of tobacco use among persons 15 years and older  (%)': 27.2,
        'Annual mean concentrations of fine particulate matter (PM2.5) in urban areas (µg/m3)': 58.1,
    ...
    'BRA': {
      ...
      indicators: {
        ...
        'Adolescent birth rate (per 1000 women aged 15-19 years)': 53.3,
        'Age-standardized mortality rate attributed to household and ambient air pollution  (per 100 000 population)': 11.6,
        'Age-standardized prevalence of tobacco use among persons 15 years and older  (%)': 12.8,
        'Annual mean concentrations of fine particulate matter (PM2.5) in urban areas (µg/m3)': 11.5,
        'Average of 15 International Health Regulations core capacity scores': 50.0,
        'Density of dentists (per 10 000 population)': 12.0,
        'Density of medical doctors (per 10 000 population)': 22.5,
        'Density of nursing and midwifery personnel (per 10 000 population)': 105.8,
    ...
    'RUS': {
      ...
      indicators: {
        'Adolescent birth rate (per 1000 women aged 10-14 years)': 0.0,
        'Adolescent birth rate (per 1000 women aged 15-19 years)': 15.2,
        'Age-standardized mortality rate attributed to household and ambient air pollution  (per 100 000 population)': 16.7,
        'Age-standardized prevalence of tobacco use among persons 15 years and older  (%)': 26.8,
        'Annual mean concentrations of fine particulate matter (PM2.5) in urban areas (µg/m3)': 13.2,
        'Average of 15 International Health Regulations core capacity scores': 48.0,
    ...
    'CAN': {
      ...
      indicators: {
        ...
        'Age-standardized mortality rate attributed to household and ambient air pollution  (per 100 000 population)': 7.4,
        'Age-standardized prevalence of tobacco use among persons 15 years and older  (%)': 15.8,
        'Annual mean concentrations of fine particulate matter (PM2.5) in urban areas (µg/m3)': 7.4,
        'Average of 15 International Health Regulations core capacity scores': 75.0,
        'Density of dentists (per 10 000 population)': 6.2,
        'Density of medical doctors (per 10 000 population)': 28.1,
        'Density of nursing and midwifery personnel (per 10 000 population)': 104.0,
        'Density of pharmacists (per 10 000 population)': 11.7,
        'Diphtheria-tetanus-pertussis (DTP3) immunization coverage among 1-year-olds (%)': 91.0,
        'Domestic general government health expenditure (GGHE-D) as percentage of general government expenditure (GGE) (%)': 18.6,
        'Healthy life expectancy at birth (years)': 70.0,
        'Hepatitis B surface antigen (HBsAg) prevalence among children under 5 years (%)': 0.3,
    ...
    'ETH': {
      ...
      indicators: {
        'Adolescent birth rate (per 1000 women aged 10-14 years)': 0.5,
        'Adolescent birth rate (per 1000 women aged 15-19 years)': 58.0,
        'Age-standardized mortality rate attributed to household and ambient air pollution  (per 100 000 population)': 238.0,
        'Age-standardized prevalence of tobacco use among persons 15 years and older  (%)': 3.3,
        'Annual mean concentrations of fine particulate matter (PM2.5) in urban areas (µg/m3)': 25.9,
    ...
    'ZAF': {
      ...
      indicators: {
        ...
        'Adolescent birth rate (per 1000 women aged 15-19 years)': 29.7,
        'Age-standardized mortality rate attributed to household and ambient air pollution  (per 100 000 population)': 22.9,
        'Age-standardized prevalence of tobacco use among persons 15 years and older  (%)': 20.3,
        'Annual mean concentrations of fine particulate matter (PM2.5) in urban areas (µg/m3)': 24.6,
    ...
    'KEN': {
      ...
      indicators: {
        ...
        'Adolescent birth rate (per 1000 women aged 15-19 years)': 78.0,
        'Age-standardized mortality rate attributed to household and ambient air pollution  (per 100 000 population)': 41.6,
        'Age-standardized prevalence of tobacco use among persons 15 years and older  (%)': 12.9,
        'Annual mean concentrations of fine particulate matter (PM2.5) in urban areas (µg/m3)': 15.6,
