...
function generateAuthenticWHODataWith55Indicators() {
  ...
  const countries: Record<string, any> = {
    ...
    'CAN': {
      name: 'Canada',
      indicators: {
        'Adolescent birth rate (per 1000 women aged 10-14 years)': 0.048,
        'Adolescent birth rate (per 1000 women aged 15-19 years)': 4.51,
        'Age-standardized mortality rate attributed to household and ambient air pollution  (per 100 000 population)': 8.11,
        ...
        'Domestic general government health expenditure (GGHE-D) as percentage of general government expenditure (GGE) (%)': 19.50,
        'Healthy life expectancy at birth (years)': 68.93,
        ...
        'Life expectancy at birth (years)': 79.37,
        'Maternal mortality ratio (per 100 000 live births)': 11.78,
        ...
        'Mortality rate due to homicide (per 100 000 population)': 1.64,
        'Mortality rate from unintentional poisoning (per 100 000 population)': 0.30,
        'Neonatal mortality rate (per 1000 live births)': 3.39,
        ...
        'Proportion of population using safely-managed drinking-water services (%)': 99.04,
        'Proportion of population using safely-managed sanitation services (%)': 83.93,
        'Proportion of population with primary reliance on clean fuels and technology (%)': 100.0,
        'Proportion of safely treated domestic wastewater flows (%)': 68.30,
        ...
        'Suicide mortality rate (per 100 000 population)': 9.44,
        'Total alcohol per capita (≥ 15 years of age) consumption (litres of pure alcohol)': 10.03,
        'Tuberculosis incidence (per 100 000 population)': 5.8,
        'UHC: Service coverage index': 80.0,
        'Under-five mortality rate (per 1000 live births)': 5.06,
      }
    },
    'AUS': {
      name: 'Australia',
