  ...
  const countries: Record<string, any> = {
    ...
    'CHN': {
      ...
      indicators: {
        ...
        'Domestic general government health expenditure (GGHE-D) as percentage of general government expenditure (GGE) (%)': 8.80,
        'Healthy life expectancy at birth (years)': 67.21,
